	...
	stub->async()->filedowm(context.get(), request.get(), response.get(),
							[context, request, response, callback](::grpc::Status status)
							{
								if (status.ok() && response->code() == 0)
								{
									...
									ret["status"] = response->code();
									ret["message"] = response->message();
									LOG_INFO("[filedowm] user:{}   find {} download", request->username(), request->filename());
									auto resp = drogon::HttpResponse::newHttpJsonResponse(ret);
									resp->setStatusCode(k200OK);
									callback(resp);
								}
								...
								{
									LOG_INFO("[filedowm] user:{}   find {} download file", request->username(), request->filename());
									Json::Value ret;
									ret["error"] = "grpc_error";
									ret["details"] = status.error_message();
									auto resp = drogon::HttpResponse::newHttpJsonResponse(ret);
	...
	stub->async()->Showfile(context.get(), request.get(), response.get(),
							[context, request, response, callback](::grpc::Status status)
							{
								if (status.ok() && response->code() == 0)
								{
									...
									ret["status"] = response->code();
									ret["message"] = response->message();
									LOG_INFO("[Showfile] user:{}   find {} show", request->username(), request->filename());
									auto resp = drogon::HttpResponse::newHttpJsonResponse(ret);
									resp->setStatusCode(k200OK);
									callback(resp);
								}
								...
								{
									LOG_INFO("[Showfile] user:{}   find {} show file", request->username(), request->filename());
									Json::Value ret;
									ret["error"] = "grpc_error";
									ret["details"] = status.error_message();
									auto resp = drogon::HttpResponse::newHttpJsonResponse(ret);
